...
function buildTenant1Deals(tenantId: string, c: ReturnType<typeof buildTenant1Contacts>, u: ReturnType<typeof buildUsers>) {
  ...
  // --- Histórico de compras (deals ganhos) que sustenta o journeyStatus ---
  // Clientes: exatamente 1 ganho cada (eduardo e vanessa já têm o seu acima).
  // Recorrentes: 2+ ganhos cada. Datas espalhadas pelos últimos 1-6 meses.

  const patriciaHist: Deal = {
    id: newId("deal"),
    tenantId,
    contactId: c.patricia.id,
    title: "iPhone 12 64GB",
    products: "iPhone 12 64GB Branco",
    value: 2899,
    payment: "pix",
    tradeIn: false,
    stage: "pos_venda",
    outcome: "ganho",
    ownerId: u.rafael.id,
    stageChangedAt: daysAgo(88),
    createdAt: daysAgo(93),
  };
  const felipeHist: Deal = {
    id: newId("deal"),
    tenantId,
    contactId: c.felipe.id,
    title: "MacBook Air M1 256GB",
    products: "MacBook Air M1 256GB Dourado",
    value: 5799,
    payment: "boleto",
    tradeIn: false,
    stage: "pos_venda",
    outcome: "ganho",
    ownerId: u.samuel.id,
    stageChangedAt: daysAgo(118),
    createdAt: daysAgo(123),
  };
  const renataHist: Deal = {
    id: newId("deal"),
    tenantId,
    contactId: c.renata.id,
    title: "AirPods 3ª geração",
    products: "AirPods 3ª geração",
    value: 1499,
    payment: "cartao_avista",
    tradeIn: false,
    stage: "pos_venda",
    outcome: "ganho",
    ownerId: u.juliana.id,
    stageChangedAt: daysAgo(62),
    createdAt: daysAgo(66),
  };
  const marceloHist1: Deal = {
    id: newId("deal"),
    tenantId,
    contactId: c.marcelo.id,
    title: "iPhone 14 Pro 256GB",
    products: "iPhone 14 Pro 256GB Roxo-profundo",
    value: 7499,
    payment: "cartao_parcelado",
    tradeIn: true,
    tradeInDesc: "iPhone 12 Pro 128GB",
    stage: "pos_venda",
    outcome: "ganho",
    ownerId: u.juliana.id,
  ...
  const marceloHist2: Deal = {
    ...
    products: "iPad Pro 11\" M2 128GB Wi-Fi",
    value: 8299,
    payment: "pix",
    tradeIn: false,
    stage: "pos_venda",
    outcome: "ganho",
    ownerId: u.juliana.id,
    stageChangedAt: daysAgo(75),
    createdAt: daysAgo(80),
  };
  const deboraHist1: Deal = {
    id: newId("deal"),
    tenantId,
    contactId: c.debora.id,
    title: "MacBook Pro 14\" M3",
    products: "MacBook Pro 14\" M3 512GB Prateado",
    value: 14999,
    payment: "cartao_avista",
    tradeIn: false,
    stage: "pos_venda",
    outcome: "ganho",
    ownerId: u.samuel.id,
    stageChangedAt: daysAgo(148),
    createdAt: daysAgo(155),
  };
  const deboraHist2: Deal = {
    id: newId("deal"),
    tenantId,
    contactId: c.debora.id,
    title: "Apple Watch Series 9",
    products: "Apple Watch Series 9 41mm Meia-noite",
    value: 3999,
    payment: "pix",
    tradeIn: false,
    stage: "pos_venda",
    outcome: "ganho",
    ownerId: u.samuel.id,
    stageChangedAt: daysAgo(58),
    createdAt: daysAgo(63),
  };
  const rodrigoHist1: Deal = {
    id: newId("deal"),
    tenantId,
    contactId: c.rodrigo.id,
    title: "iPhone 13 Pro 128GB",
    products: "iPhone 13 Pro 128GB Grafite",
    value: 5499,
    payment: "pix",
    tradeIn: true,
    tradeInDesc: "iPhone XR 64GB",
    stage: "pos_venda",
    outcome: "ganho",
    ownerId: u.rafael.id,
  ...
  const rodrigoHist2: Deal = {
    ...
    products: "iPhone 15 256GB Preto",
    value: 5999,
    payment: "cartao_parcelado",
    tradeIn: false,
    stage: "pos_venda",
    outcome: "ganho",
    ownerId: u.rafael.id,
    stageChangedAt: daysAgo(44),
    createdAt: daysAgo(50),
  };
  const fernandaHist1: Deal = {
    id: newId("deal"),
    tenantId,
    contactId: c.fernanda.id,
    title: "AirPods Pro 2",
    products: "AirPods Pro 2 com estojo MagSafe",
    value: 1899,
    payment: "pix",
    tradeIn: false,
    stage: "pos_venda",
    outcome: "ganho",
    ownerId: u.juliana.id,
    stageChangedAt: daysAgo(170),
    createdAt: daysAgo(175),
  };
  const fernandaHist2: Deal = {
    id: newId("deal"),
    tenantId,
    contactId: c.fernanda.id,
    title: "Kit capa + carregador MagSafe",
    products: "Capa de silicone iPhone 15 + Carregador MagSafe 15W",
    value: 749,
    payment: "cartao_avista",
    tradeIn: false,
    stage: "pos_venda",
